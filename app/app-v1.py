...
model_directory = "./app/TrainedModel"
...
def hello_world():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            # Load the selected model from the specified directory
            model_filename = os.path.join(model_directory, f"{selected_model}_model.joblib")
